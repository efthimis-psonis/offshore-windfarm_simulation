...
def format_power_curve(wind_speeds, power_values):
    return pd.DataFrame({"wind_speed": wind_speeds, "value": [p * 1000 for p in power_values]})  # Convert MW to W
# 🔹 Step 1: Define the wind turbine models using windpowerlib-compatible structure
MODEL_SPECS = {
    "Vestas V90-3": {
        "nominal_power": 3e6,
        "hub_height": (65+105)/2,
    ...
    "Senvion 126": {
        "nominal_power": 6.15e6,  # Convert MW to W
        "hub_height": (85+117)/2,  # meters
    ...
    "Repower": {
        "nominal_power": 5e6,  # Convert MW to W
        "hub_height": (90+120)/2,  # meters
        "rotor_diameter": 126,  # meters
        "cut_in": 3.5,
        "cut_out": 30,
        "power_curve": format_power_curve(
    ...
    "Haliade 150": {
        "nominal_power": 3e6,  # Convert MW to W
        "hub_height": 100,  # meters
        "rotor_diameter": 151,  # meters
        "cut_in": 3.5,
        "cut_out": 30,
        "power_curve": format_power_curve(
            [3.5, 4, 4.5, 5, 5.5, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10, 10.5, 11, 11.5, 12, 12.5, 13, 25],
